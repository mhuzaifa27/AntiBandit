...
public class GPSLocator extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageForGPS = StorageForGPS.getInstance(this);
        editText=(EditText) findViewById(R.id.te_passphrase);
        ...
        clickButton.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!editText.getText().toString().trim().equalsIgnoreCase("")){
                    Context context = getApplicationContext(); // Inside a fragment
                    Intent returnIntent = new Intent();
                    returnIntent.putExtra("CODE_SAVED",true);
                    setResult(Activity.RESULT_OK,returnIntent);
                    displayToast("GPS Location Mode is Enabled");
                    finish();
                }
                else{
    ...
    */
    ...
    private void initPassphraseEdit(){
        ...
        tePassphrase.setText(storageForGPS.getCurrentPassphrase());
    }
    ...
    @Override
    public void onPause(){
        storageForGPS.savePassphrase(getPassphraseFromInput());
        super.onPause();
    }
    ...
    private void enableBroadcastReceiver(boolean enable){
        ComponentName component = new ComponentName(this, SmsListenerForGPS.class);
